...
public class Tests {
    ...
    public void test01ComprueboQueLosGuerrerosSonGuerrerosZ() {
    	...
    	Goku g = new Goku();
    	Vegeta go = new Vegeta();
    	Trunks p = new Trunks();
    	boolean condition = g instanceof GuerreroZ && go instanceof GuerreroZ && p instanceof GuerreroZ;
    	print_test("Goku, Vegeta y Trunks son Guerreros Z",condition);
    	if(condition) nota+=0.5;

    }

    @Test
    public void test02ComprueboLosPunietazosDeTrunksYVegeta() {
    	System.out.println("Test 2 - Valor: 1 pto");
    	EnemigoDeLaTierra e = new EnemigoDeLaTierra();
    	Vegeta go = new Vegeta();
    	Trunks p = new Trunks();
    	go.punietazo(e);
    	boolean ca = e.vida == 120;
    	p.punietazo(e);
    	boolean cb = e.vida == 40;
    	boolean condition = ca&&cb;
    	print_test("Los punietazos de Vegeta y Trunks restan  80 cada uno",condition);
    	if(condition) nota+=1;
    ...
    public void test05ComprueboAtaquesEspeciales(){
    	...
    	Goku g = new Goku();
    	g.kamehameha(e);
    	boolean ca = e.vida == 30;
    	e=new EnemigoDeLaTierra();
    	go.bigBang(e);
    	boolean cb= e.vida==70;
    	e=new EnemigoDeLaTierra();
    	p.ondaEspada(e);
    	boolean cc = e.vida==90;
