...
public class Tests {
    ...
    @Test
    public void test09PrueboElFactorialConCoordenadaCero(){
    	System.out.println("Test 9 - Valor: 2 ptos");
    	Vector v = new Vector(0,3);
    	v.vectorFactorial();
    	boolean condition=v.esIgual(new Vector(1,6));
    	print_test("Pruebo el vector factorial con una coordenada 0",condition);
    	if (condition) nota+=2;
    }
    ...
    public void test10(){
    	...
    	v.vectorFactorial();
    	boolean condition=v.esIgual(new Vector(120,720));
    	print_test("Pruebo el vector factorial con el ejemplo del examen",condition);
    	if (condition) nota+=2;
    }
